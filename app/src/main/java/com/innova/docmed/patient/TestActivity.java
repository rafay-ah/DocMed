...
import static com.innova.docmed.fragments.BookingStep1Fragment.spinner;
import static com.innova.docmed.utilities.Common.step;
...
import com.innova.docmed.utilities.NonSwipeViewPager;
import com.innova.docmed.utilities.adapter.MyViewPagerAdapter;
...
public class TestActivity extends AppCompatActivity {
    ...
    private void setColorButton() {
        if(btn_previous_step.isEnabled()){
            ...
            btn_previous_step.setBackgroundResource(R.color.base);
        }
        if(btn_next_step.isEnabled()){
            btn_next_step.setBackgroundResource(R.color.design_default_color_primary_dark);
        }
        else{
            btn_next_step.setBackgroundResource(R.color.base);
        }
    }
